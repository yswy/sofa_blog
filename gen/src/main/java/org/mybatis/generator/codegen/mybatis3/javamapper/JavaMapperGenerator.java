...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.UserDefindSqlMethodGenerator;
...
//        addUpdateByPrimaryKeyWithoutBLOBsMethod(interfaze);
        ...
        //增加自定义sql
        addUserDefindSqlMethod(interfaze);
    ...
    protected void addUserDefindSqlMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateUserDefindSql()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new UserDefindSqlMethodGenerator();
